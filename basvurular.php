...
<base href="https://sandreas-roleplay.com/ucp/">
  ...
  <title>San Andreas Roleplay - Karakter Başvuruları</title>
</head>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
		...
		<div style="background: #fff; height: 77px; border-bottom: 1px solid #D8D8D8; padding-left: 20px;" class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 style=" class="h3 mb-0 text-gray-800"><strong>Karakter Başvuruları</strong></h1>
		</div>
        <!-- Topbar -->
        <!-- Container Fluid-->
		<div class="container-fluid" id="container-wrapper">
		 <div class="row">
            <div class="card-body">
              <div class="card mb-4">
                <div class="card-body">
				<center><img style="width:400px;height:90px" src="img/logo/logo2.png"></center>
				<br>
				<?php
				$appquery = mysqli_query($baglanti, "SELECT * from applications");
				if($order1 = mysqli_num_rows($appquery)){
			    ?>
				<div class="infobar success">
			    <div class="icon">
				<i class="fas fa-check"></i></div>
			    <div class="message">Şu anda <b><?php echo $order1 ?></b> adet karakter başvurusu bulunmakta.</div></div><br><br><br>
              <div style="box-shadow:0 0rem 0rem 0 rgba(0,0,0,0.2)!important;border:1px solid #ddd;" class="card">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Karakter Başvuruları</h6>
                </div>
                <div class="table-responsive">
                  <table class="table align-items-center table-flush">
					...
					?>
                      <tr>
                        <td><?php echo $application['app_dbid'] ?></td>
                        <td><?php echo $application['app_char_name'] ?></td>
                        <td><?php echo $application['app_forum_name'] ?></td>
                        <td><span class="badge badge-success"><?php echo $application['app_register_date'] ?></span></td>
                        <td>
						<a href="basvuru-incele/<?php echo $application['app_dbid'] ?>" style="font-size:11px;" class="btn btn-sm btn-dark">Detay</a>
						<a href="basvuru-incele/<?php echo $application['app_dbid'] ?>" style="font-size:11px;" class="btn btn-sm btn-danger">Sil</a>
						</td>
                      </tr>
                    </tbody>
                  </table>
			    ...
			    <div class="message">Şu anda karakter başvurusu bulunmuyor.</div></div>
				<?php } ?>
            </div>
          </div>
        </div>
