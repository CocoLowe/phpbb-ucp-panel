    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
		...
		<div class="container-fluid" id="container-wrapper">
		 ...
		 <?php
		  ...
		  ?>
              <div class="card mb-4">
                <div class="card-body">
				<center><img style="width:400px;height:90px" src="https://sandreas-roleplay.com/ucp/img/logo/logo2.png"></center>
				<br>
		<?php
		...
		echo ' 
			...
			header("refresh:3;url=https://sandreas-roleplay.com/ucp");
		}
        }
		if(!isset($_SESSION["test"])){
					...
					$app_password = strtoupper(hash('whirlpool', $_POST["app_password"]));
					$app_password1 = strtoupper(hash('whirlpool', $_POST["app_password1"]));
			        ...
			        <div class="icon">
				    <i class="fas fa-check"></i></div>
			        <div class="message">Karakter başvurunu başarıyla bize ulaştırdın sayfayı yenileyerek başvurun hakkında bilgilere sahip olabilir ve düzenleyebilirsin.</div></div><br><br>';
					}
					else{ echo '					
					<div class="infobar error">
			        <div class="icon">
